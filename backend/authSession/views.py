...
def kill_all_sessions(request):
    ...
    return JsonResponse({'detail': 'Сесси успешно завершены'})


# Красиво всё укомплектовать на GIT
# Прочитать все статьи из закладок, связанные с авторизацией и начать писать статью